...
$Select_Query = "select status from offer where id = '$Id'";
$Select_Query_Result = mysqli_query($connect_db, $Reg_Query);

if ($Reg_Query_Result == 'on') 
{

    $Message = "loffre est deja publier";
    ...
    $Reg_Query = "UPDATE `offer`SET `status`= 'on' WHERE id = '$Id'";
