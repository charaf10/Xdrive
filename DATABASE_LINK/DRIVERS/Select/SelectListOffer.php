...
$vehicule = $Decode_React_APP_Data['vehicule'];
$shift = $Decode_React_APP_Data['shift'];
...
$query = "SELECT * FROM offer WHERE status = 'on' and typeVehicule = '$vehicule' and typeShift = '$shift' and location = '$location'";
