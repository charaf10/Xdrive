...
$sql = "INSERT INTO $tableName (idDriver, nameVehicule, nameShiftType, location, rayon) VALUES (?, ?, ?, ?, ?)";
$stmt = $connect_db->prepare($sql);
$stmt->bind_param("issss" , $data['idDriver'], $data['nameVehicule'], $data['nameShiftType'], $data['location'], $data['rayon']);
