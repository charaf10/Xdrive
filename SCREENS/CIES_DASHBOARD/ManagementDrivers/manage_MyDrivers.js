...
import WorkerDetailScreen from '../../Schedule/SCH_composant/driver/WorkerDetailScreen'; // Assurez-vous d'importer votre composant correctement
import ListWorkers from '../../Schedule/worker/ListWorkers'; // Assurez-vous d'importer votre composant correctement
...
const DriversListPage = ({ route}) => {
  ...
  /*======================================LES FONCTIONS============================================= */
    ...
    const fetchAllDrivers = async () => {
      ...
      try {
        const response = await axios.post('http://' + myip + ':80/link/entreprise/get_myDrivers.php', {id: identreprise});
